...
def stress_test_decision_net(
    ...
    print(f"  motion_map shape:   {tuple(batch_motion_map.shape)}")
    ...
    print("\n【CPU】")
    print(f"  avg CPU time: {cpu_times.mean():.3f} ms")
...
if __name__ == "__main__":
    ...
    MODEL_PATH = "/home/dell/lyra/ILCAS/Results/history/ILCAS_20000_0.685968_3.695348.model"
    # ===============================
    # 5. 内存 before
    # ===============================
